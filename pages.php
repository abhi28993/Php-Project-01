...
include './database/db.php';
					...
					{
						extract($_POST);
						$query="INSERT INTO `sub` (`id`,`sub`) VALUES (NULL,'$sub')";
	...
	<div class="main">
		  	<div class="wrap">
               ...
               <div class="email_box">
					<form method="post">
						<div class="email">
					  		 <input type="text" name="sub" value="Enter Your e-mail" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter Your e-mail';}">
					  	</div>
					  	 <div class="button">
						   	 <span><input type="submit" name="submit" value="Subscribe"></span>
						</div>
				    </form>
